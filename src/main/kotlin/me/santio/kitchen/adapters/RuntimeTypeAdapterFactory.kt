...
class RuntimeTypeAdapterFactory<T> private constructor(
    baseType: Class<*>?, typeFieldName: String?, maintainType: Boolean
) : TypeAdapterFactory {
        ...
        return object : TypeAdapter<R>() {
            ...
            override fun read(`in`: JsonReader): R {
                ...
                labelJsonElement = if (maintainType) {
                    jsonElement.getAsJsonObject()[typeFieldName]
                } else {
            ...
            override fun write(out: JsonWriter, value: R) {
                ...
                val jsonObject = delegate.toJsonTree(value).getAsJsonObject()
                if (maintainType) {
